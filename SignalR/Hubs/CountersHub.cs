namespace SignalRDemo.SignalR
{
    ...
    public class CountersHub : Hub
    {
        ...
        public CountersHub(
            IPersistentConnectionContext<HubConnection> rawConnectionContext)
        {
        ...
        public override async Task OnConnected()
        {
            ...
            {
                type = HubConnection.MessageType.Broadcast.ToString(),
                from = Context.ConnectionId,
                data = "Connected to CountersHub!"
            });
        }
        ...
        public async Task<long> GetValue(string id)
        {
